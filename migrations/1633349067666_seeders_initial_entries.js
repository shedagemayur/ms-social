module.exports = {
    "up": async function (connection, cb) {
        try {
            ...
            await connection.promise().query("INSERT INTO `groups` VALUES ('supergroup','Comic Heros Hangout','public',NULL,'https://data-us.cometchat.io/assets/images/avatars/supergroup.png',NULL,NULL,'superhero1',0,1629373580,NULL,1629373580);");
            ...
            await connection.promise().query("INSERT INTO `roles` VALUES ('default','Default Role','This role is provided by default',NULL,'Migration',1629373580,NULL,1629373580);");
        } catch (error) {
            console.log(error);
        }
        finally {
    ...
    "down": async function (connection, cb) {
        try {
            ...
            await connection.promise().query("DELETE FROM `roles` WHERE role = 'default';");
        } catch (error) {
            console.log(error);
        }
        finally {
